...
export type TextColor = 
  ...
  | 'indigo-1' | 'indigo-2' | 'indigo-3' | 'indigo-4' | 'indigo-5' | 'indigo-6'
  | 'purple-1' | 'purple-2' | 'purple-3' | 'purple-4' | 'purple-5' | 'purple-6'
  | 'gray-1' | 'gray-2' | 'gray-3' | 'gray-4' | 'gray-5' | 'gray-6'
  | 'dark-blue-1' | 'dark-blue-2' | 'dark-blue-3' | 'dark-blue-4' | 'dark-blue-5' | 'dark-blue-6';
...
function Text({ 
  ...
  const getVariantClass = (variant: TextVariant): string => {
    switch (variant) {
      case 'headline-1': return 'notes-headline-1';
      case 'headline-2': return 'notes-headline-2';
      case 'headline-3': return 'notes-headline-3';
      case 'headline-4': return 'notes-headline-4';
      case 'headline-5': return 'notes-headline-5';
      case 'headline-6': return 'notes-headline-6';
      case 'body': return 'notes-body';
      case 'subhead': return 'notes-subhead';
      case 'secondary': return 'notes-secondary';
      case 'disabled': return 'notes-disabled';
      case 'caption': return 'notes-caption';
      default: return 'notes-body';
    }
  };
