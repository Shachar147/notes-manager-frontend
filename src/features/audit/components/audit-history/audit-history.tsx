            ...
            return (
              <div key={log.id} className="audit-log">
                <div className="audit-log-header">
                  <Text variant="headline-6" className="event-type">
                    {getEventTypeLabel(log.eventType)}
                  </Text>
                  <Text variant="subhead" className="timestamp">
